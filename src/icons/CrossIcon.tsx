...
const CrossIcon = ({size, fill = colors.black, ...props}: ICrossIconProps) => {
  return (
    <Svg height={size} width={size} viewBox="0 0 15 15" fill={fill} {...props}>
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
...
export function MakiCross(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
